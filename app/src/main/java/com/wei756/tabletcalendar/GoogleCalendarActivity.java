...
public class GoogleCalendarActivity extends AppCompatActivity
    ...
    public static final String TYPE_ALL = "모두";
    public static final String TYPE_HOLIDAY = "대한민국의 휴일";
    public static final String TYPE_CALENDAR = "탁상달력";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_googlecalendar);
        ...
        currentYear = intent.getExtras().getInt("year");
        getType = intent.getExtras().getString("type", TYPE_ALL);
    }
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, String> {
        ...
        private GoogleCalendarActivity mActivity;
        List<String> eventStrings = new ArrayList<String>();


        public MakeRequestTask(GoogleCalendarActivity activity, GoogleAccountCredential credential) {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                if (mID == 1) {
                    ...
                    return getEvent(currentYear, getType);
                }
         ...
         */
        private String getEvent(int year, String calendarName) throws IOException {


            DateTime now = new DateTime(System.currentTimeMillis());
            DateTime currentYear = null, nextYear = null;
            try {
                currentYear = new DateTime(new SimpleDateFormat("yyyy").parse("" + year));
                nextYear = new DateTime(new SimpleDateFormat("yyyyMMdd").parse((year + 1) + "0101"));
            } catch (ParseException ex) {
                Log.v("Exception", ex.getLocalizedMessage());
            }

            String calendarID;
            if (calendarName.equals(TYPE_ALL)) {
                return getEvent(year, TYPE_CALENDAR) + getEvent(year, TYPE_HOLIDAY);
            } else
                calendarID = getCalendarID(calendarName);
            if (calendarID == null) {
        ...
        private String createCalendar() throws IOException {
            ...
            String ids = getCalendarID(TYPE_CALENDAR);
            ...
            // 캘린더의 제목 설정
            calendar.setSummary(TYPE_CALENDAR);
            ...
            calendarListEntry.setBackgroundColor("#4455dd");
        ...
        protected void onPostExecute(String output) {
            ...
            if (mID == 3) { // get events
                ...
                intent.putStringArrayListExtra("events", (ArrayList<String>) eventStrings);
                setResult(100, intent);
                mProgress.dismiss();
                Log.e("test", "close activity");
                finish();
            }
        }
